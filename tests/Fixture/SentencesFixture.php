...
class SentencesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'original' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'translated' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2019-05-20 01:51:39',
                'modified' => '2019-05-20 01:51:39'
            ],
        ];
        parent::init();
    }
